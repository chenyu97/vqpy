...
if __name__ == "__main__":
    ...
    name_list = ['./input_videos/ua_detrac.mp4']
    ...
    for index, name in enumerate(name_list):
        ...
        parser.add_argument("--save_folder", help="path to save query result",
                            default="./results_Q2_check/" + query["color"] + '_' + query["type"] + '_' + query["direction"] + "/")
        ...
        end_time = time.time()
        with open('./result_check/Q2_time_cost_' + str(index) + '_' + str(time.time()), 'a') as file:
