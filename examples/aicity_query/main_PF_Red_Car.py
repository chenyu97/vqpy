...
if __name__ == "__main__":
    ...
    end_time = time.time()
    register_tracker_time = end_time - start_time
    ...
    for name in name_list:
        ...
        parser.add_argument("--save_folder", help="path to save query result",
                            default="./results_PF/" + query["color"] + '_' + query["type"] + '_' + query["direction"] + "/")
    ...
    print('register_tracker_time: ' + str(register_tracker_time))
