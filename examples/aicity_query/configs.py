...
_C.DATA.TEST_TRACKS_JSON_PATH = "./data/json/original_data/filtered-test-tracks.json"
...
# Test configurations
_C.TEST = CN()
#_C.TEST.INFERENCE_FROM = "./models/weights/checkpoint_recognition_color.pth"
_C.TEST.INFERENCE_FROM = "./models/weights/checkpoint_recognition_type.pth"
_C.TEST.QUERY_JSON_PATH = "./data/json/test-queries.json"
#_C.TEST.ID_JSON = "./data/json/recognition/color_id.json"
_C.TEST.ID_JSON = "./data/json/recognition/type_id.json"
