...
if __name__ == "__main__":
    ...
    # # prepare video names
    # name_list = [ '../../../Three_Datasets/Banff/cut_videos/3min_banff_sat_am001.mp4', # 1, 3min
    #              '../../../Three_Datasets/Banff/banff_sat_am001.mp4', # 1, 10min
    ...
    #     vqpy.run(executor=query_executor, save_folder=args.save_folder)
    #     end_time = time.time()
    #     with open('./result/Q2_time_cost_' + str(index) + '_' + time.strftime("%Y.%m.%d.%H.%M.%S"), 'a') as file:
